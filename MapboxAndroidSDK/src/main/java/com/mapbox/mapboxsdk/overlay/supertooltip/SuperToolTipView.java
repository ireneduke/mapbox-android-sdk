...
package com.mapbox.mapboxsdk.overlay.supertooltip;
 ...
 */
public class SuperToolTipView extends LinearLayout implements ViewTreeObserver.OnPreDrawListener, View.OnClickListener
{
	...
	public SuperToolTipView(Context context)
	{
		super(context);
		init();
	}
	...
	public void setToolTip(SuperToolTip toolTip, View view)
	{
		mToolTip = toolTip;
		mView = view;
	...
	private void applyToolTipPosition()
	{
		...
		if (mToolTip.getAnimationType() == SuperToolTip.ANIMATIONTYPE_FROMMASTERVIEW)
		{
		...
		else if (mToolTip.getAnimationType() == SuperToolTip.ANIMATIONTYPE_FROMTOP)
		{
	...
	public void remove()
	{
		...
		animatorSet.addListener(new Animator.AnimatorListener()
		{
			...
			public void onAnimationEnd(Animator animator)
			{
				if (getParent() != null)
				{
					((ViewGroup) getParent()).removeView(SuperToolTipView.this);
				}
			}
	...
	{
		public void onToolTipViewClicked(SuperToolTipView toolTipView);
	}
}