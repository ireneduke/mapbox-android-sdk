...
public class SuperToolTip {
	 ...
	 */
	public SuperToolTip withText(CharSequence text) {
		this.text = text;
		this.textResId = 0;
		return this;
	}
	 ...
	 * @return this ToolTip to build upon.
	 */
	public SuperToolTip withText(int resId) {
	 ...
	 * @return this ToolTip to build upon.
	 */
	public SuperToolTip withColor(int color) {
		this.color = color;
		return this;
	}
	 ...
	 * @return this ToolTip to build upon.
	 */
	public SuperToolTip withContentView(View view) {
	 ...
	 * @return this ToolTip to build upon.
	 */
	public SuperToolTip withAnimationType(int animationType) {
	 ...
	 * @return this ToolTip to build upon.
	 */
	public SuperToolTip withShadow(boolean shadow) {
		this.shadow = shadow;
		return this;
	}
